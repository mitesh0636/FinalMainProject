...
export class NameOfMigration1775299229572 implements MigrationInterface {
    name = 'NameOfMigration1775299229572'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "ORDER" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "TotalPayment" decimal(10,2) NOT NULL, "TaxApplied" decimal(10,2) NOT NULL DEFAULT (0), "SubTotal" decimal(10,2) NOT NULL DEFAULT (0), "orderDate" datetime NOT NULL DEFAULT (CURRENT_TIMESTAMP), "deliveryDate" datetime NOT NULL, "orderstatus" varchar CHECK( "orderstatus" IN ('ordered','dispatched','cancelled','delivered') ) NOT NULL, "paymentMethod" varchar CHECK( "paymentMethod" IN ('credit','debit','banktransfer','cashondelivery') ) NOT NULL, "userId" integer)`);
        ...
        await queryRunner.query(`CREATE TABLE "PRODUCT" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "description" varchar NOT NULL, "price" integer NOT NULL, "available" integer NOT NULL, "imagePath" varchar NOT NULL, "isDeleted" boolean NOT NULL DEFAULT (0), "subCategoryId" integer)`);
        ...
        await queryRunner.query(`CREATE TABLE "CART" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "userId" integer, CONSTRAINT "REL_44dcec32d1366b0e664d3ddbde" UNIQUE ("userId"))`);
        await queryRunner.query(`CREATE TABLE "USERS" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "email" varchar NOT NULL, "dateofbirth" date, "password" varchar NOT NULL, "address" varchar NOT NULL, "contactno" varchar NOT NULL, "role" varchar CHECK( "role" IN ('admin','user') ) NOT NULL DEFAULT ('user'), "isLocked" boolean NOT NULL DEFAULT (0), "createdAt" datetime NOT NULL DEFAULT (CURRENT_TIMESTAMP), CONSTRAINT "UQ_a1689164dbbcca860ce6d17b2e1" UNIQUE ("email"))`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_ORDER" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "TotalPayment" decimal(10,2) NOT NULL, "TaxApplied" decimal(10,2) NOT NULL DEFAULT (0), "SubTotal" decimal(10,2) NOT NULL DEFAULT (0), "orderDate" datetime NOT NULL DEFAULT (CURRENT_TIMESTAMP), "deliveryDate" datetime NOT NULL, "orderstatus" varchar CHECK( "orderstatus" IN ('ordered','dispatched','cancelled','delivered') ) NOT NULL, "paymentMethod" varchar CHECK( "paymentMethod" IN ('credit','debit','banktransfer','cashondelivery') ) NOT NULL, "userId" integer, CONSTRAINT "FK_0ef741dece1ca96cbcbd08a73c9" FOREIGN KEY ("userId") REFERENCES "USERS" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_ORDER"("id", "TotalPayment", "TaxApplied", "SubTotal", "orderDate", "deliveryDate", "orderstatus", "paymentMethod", "userId") SELECT "id", "TotalPayment", "TaxApplied", "SubTotal", "orderDate", "deliveryDate", "orderstatus", "paymentMethod", "userId" FROM "ORDER"`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_PRODUCT" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "description" varchar NOT NULL, "price" integer NOT NULL, "available" integer NOT NULL, "imagePath" varchar NOT NULL, "isDeleted" boolean NOT NULL DEFAULT (0), "subCategoryId" integer, CONSTRAINT "FK_2c10996e7b4c5b91d641b44ac8e" FOREIGN KEY ("subCategoryId") REFERENCES "SUBCATEGORY" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_PRODUCT"("id", "name", "description", "price", "available", "imagePath", "isDeleted", "subCategoryId") SELECT "id", "name", "description", "price", "available", "imagePath", "isDeleted", "subCategoryId" FROM "PRODUCT"`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_CART" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "userId" integer, CONSTRAINT "REL_44dcec32d1366b0e664d3ddbde" UNIQUE ("userId"), CONSTRAINT "FK_44dcec32d1366b0e664d3ddbdee" FOREIGN KEY ("userId") REFERENCES "USERS" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "PRODUCT" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "description" varchar NOT NULL, "price" integer NOT NULL, "available" integer NOT NULL, "imagePath" varchar NOT NULL, "isDeleted" boolean NOT NULL DEFAULT (0), "subCategoryId" integer)`);
        await queryRunner.query(`INSERT INTO "PRODUCT"("id", "name", "description", "price", "available", "imagePath", "isDeleted", "subCategoryId") SELECT "id", "name", "description", "price", "available", "imagePath", "isDeleted", "subCategoryId" FROM "temporary_PRODUCT"`);
        ...
        await queryRunner.query(`CREATE TABLE "ORDER" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "TotalPayment" decimal(10,2) NOT NULL, "TaxApplied" decimal(10,2) NOT NULL DEFAULT (0), "SubTotal" decimal(10,2) NOT NULL DEFAULT (0), "orderDate" datetime NOT NULL DEFAULT (CURRENT_TIMESTAMP), "deliveryDate" datetime NOT NULL, "orderstatus" varchar CHECK( "orderstatus" IN ('ordered','dispatched','cancelled','delivered') ) NOT NULL, "paymentMethod" varchar CHECK( "paymentMethod" IN ('credit','debit','banktransfer','cashondelivery') ) NOT NULL, "userId" integer)`);
        await queryRunner.query(`INSERT INTO "ORDER"("id", "TotalPayment", "TaxApplied", "SubTotal", "orderDate", "deliveryDate", "orderstatus", "paymentMethod", "userId") SELECT "id", "TotalPayment", "TaxApplied", "SubTotal", "orderDate", "deliveryDate", "orderstatus", "paymentMethod", "userId" FROM "temporary_ORDER"`);
